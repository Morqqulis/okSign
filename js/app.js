            ...
            open(selectorValue) {
                if (bodyLockStatus) {
                    ...
                    if (this.targetOpen.element) {
                        ...
                        if (document.querySelector(".wrapper_home") && document.querySelector(".popup-video").classList.contains("popup_show")) document.querySelector("video").play();
                    } else this.popupLogging(`Woops no current popup `);
                }
            }
            close(selectorValue) {
                ...
                if (document.querySelector(".popup-video")) if (!document.querySelector(".popup-video").classList.contains("popup_show")) {
